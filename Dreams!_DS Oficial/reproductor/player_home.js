...
function Init(){
    ...
    pista = document.getElementById("audio-home");
    var playlist = document.getElementById("canciones-carrusales");
    ...
    var place_img_song = document.getElementById("img-artist-1");
    ...
    for(var track in tracks){
        ...
        for(var track in tracks){
            ...
            link.addEventListener("dblclick", function(e){
                ...
                //sustiur la imagen de la canción
                var img_song = document.getElementById("img_c_song_" + name);
                var href_img = img_song.getAttribute("src");
                place_img_song.src = href_img;
            ...
            for(var track in tracks){
                ...
                if(track == (tracks.length - 1)) nextsong = 0;
                    ...
                    if(link.getAttribute("href") === this.src){
                        ...
                        //sustiur la imagen de la canción
                        var img_song = document.getElementById("img_c_song_" + (nextsong + 1));
                        var href_img = img_song.getAttribute("src");
                        place_img_song.src = href_img;
