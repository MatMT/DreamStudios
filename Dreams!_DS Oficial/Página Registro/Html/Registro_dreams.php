...
if (_isNS('google.translate.Element')){return}(function(){var c=_setupNS('google.translate._const');c._cest = gtConstEvalStartTime;gtConstEvalStartTime = undefined;c._cl='es';c._cuc='googleTranslateElementInit';c._cac='';c._cam='';c._ctkk='452756.1113537376';var h='translate.googleapis.com';var s=(true?'https':window.location.protocol=='https:'?'https':'http')+'://';var b=s+h;c._pah=h;c._pas=s;c._pbi=b+'/translate_static/img/te_bk.gif';c._pci=b+'/translate_static/img/te_ctrl3.gif';c._pli=b+'/translate_static/img/loading.gif';c._plla=h+'/translate_a/l';c._pmi=b+'/translate_static/img/mini_google.png';c._ps=b+'/translate_static/css/translateelement.css';c._puh='translate.google.com';_loadCss(c._ps);_loadJs(b+'/translate_static/js/element/main_es.js');})();})();
</script>
    ...
    <div class="mein-container">
        ...
        <form method="post" id="personal-data" action="email.php">
            ...
            <div class="datos">
                ...
                <br>
                <input type="text" name="NameType"  placeholder="Tu nombre de Usuario" class="nombre" id="NameType" required>
            </div>
            <div class="datos">
            ...
            <div class="datos">
                ...
                <br>
                <input type="password" name="PassType" placeholder="Tu contraseña segura"  class="nombre" id="PassType" required>
            </div>
            <div class="datos">
            ...
            <div class="datos_button">
                ...
                <input type="radio" name="GenderType" id="fem">
                <label for="fem" class="gender">Femenino</label>
                <br>
                <input type="radio" name="GenderType" id="masc">
